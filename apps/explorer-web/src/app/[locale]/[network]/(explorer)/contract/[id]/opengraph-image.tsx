...
export const alt = "Soroban Smart Contract";
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function Image({ params }: { params: { id: string; locale: string } }) {
  ...
  const title = locale === "es" ? "Contrato Soroban" : "Soroban Contract";
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          backgroundImage:
            "radial-gradient(circle at 20% 30%, rgba(168, 85, 247, 0.15) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(236, 72, 153, 0.1) 0%, transparent 50%)",
        }}
      />
